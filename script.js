document.addEventListener('DOMContentLoaded', function() {
    ...
    function showError(input, message) {
        ...
        const rtlDirection = getComputedStyle(input).direction;
        if (rtlDirection === 'rtl') {
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '59aaee31-e183-4f94-bfbd-d62f27950211',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '59aaee31-e183-4f94-bfbd-d62f27950211';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '59aaee31-e183-4f94-bfbd-d62f27950211';
